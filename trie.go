...
import (
	...
	rnet "github.com/grootcz/cidrfilter/net"
)
...
func newEntryTrie(network rnet.Network, entry RangerEntry) *prefixTrie {
	...
	if leaf.list == nil {
		leaf.list = make([]RangerEntry, 0, 8)
	}
	leaf.list = append(leaf.list, entry)
